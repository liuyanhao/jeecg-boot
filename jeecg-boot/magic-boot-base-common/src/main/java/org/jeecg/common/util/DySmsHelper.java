...
public class DySmsHelper {
     ...
     * 发送短信
     * @param phone 手机号码
     * @param templateParamJson 模版内容json
     * @param dySmsEnum
     * @return
    ...
    public static boolean sendSms(String phone,JSONObject templateParamJson,DySmsEnum dySmsEnum) throws ClientException {
        ...
        //update-begin-author：liuyanhao date:20200928 for:配置类数据获取
        StaticConfig staticConfig = SpringContextUtils.getBean(StaticConfig.class);
        setAccessKeyId(staticConfig.getAccessKeyId());
        setAccessKeySecret(staticConfig.getAccessKeySecret());
        //update-end-author：liuyanhao date:20200928 for:配置类数据获取
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
    	...
    	obj.put("code", "1234");
    	sendSms("18101298728", obj, DySmsEnum.FORGET_PASSWORD_TEMPLATE_CODE);
