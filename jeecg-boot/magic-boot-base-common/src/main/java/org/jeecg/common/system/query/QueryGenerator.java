...
public class QueryGenerator {
		...
		*/
		...
		for (int i = 0; i < origDescriptors.length; i++) {
			...
			try {
				...
				// update-begin--Author:liuyanhao  Date:20200910 for：issues/1671 如果字段加注解了@TableField(exist = false),不走DB查询-------
				...
				// update-end--Author:liuyanhao  Date:20200910 for：issues/1671 如果字段加注解了@TableField(exist = false),不走DB查询 -------
	...
	public static void doSuperQuery(QueryWrapper<?> queryWrapper,Map<String, String[]> parameterMap) {
		if(parameterMap!=null&& parameterMap.containsKey(SUPER_QUERY_PARAMS)){
            ...
            // update-begin--Author: liuyanhao  Date:20200928 for：高级查询的条件要用括号括起来，防止和用户的其他条件冲突 -------
            try {
            ...
            // update-end--Author:liuyanhao  Date:20200928 for：高级查询的条件要用括号括起来，防止和用户的其他条件冲突 -------
		}
	...
	private static QueryRuleEnum convert2Rule(Object value) {
		...
		//update-begin--Author:liuyanhao  Date:20190928 for：initQueryWrapper组装sql查询条件错误 #284-------------------
		...
		//update-end--Author:liuyanhao  Date:20190928 for：initQueryWrapper组装sql查询条件错误 #284---------------------
